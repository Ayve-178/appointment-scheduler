...
const Registration: React.FC = () => {
  ...
  return (
    <form
      ...
      className="w-[30%] p-8 border rounded-lg shadow-lg"
    >
      <h2 className="text-[25px] font-bold text-center">Sign up</h2>
      <div className="text-[10px] text-center text-gray-500 mb-3">
